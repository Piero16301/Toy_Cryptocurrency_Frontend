...
class VerificationRegisterPage extends StatelessWidget {
  const VerificationRegisterPage({Key? key}) : super(key: key);
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  RegisterCodeInput(verificationForm: verificationForm),
                  const SizedBox(height: 20),
        ...
        onPressed: verificationForm.isLoading
            ...
            : () async {
                ...
                final String? errorMessage =
                    await authService.verifySecurityCodeRegister(userModel,
...
class RegisterCancelButton extends StatelessWidget {
  const RegisterCancelButton({Key? key}) : super(key: key);
